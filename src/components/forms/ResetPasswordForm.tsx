...
export const ResetPasswordForm: React.FC<ResetPasswordFormProps> = ({ 
  ...
  const handleInputChange = useCallback((field: 'password' | 'confirmPassword') => (
  ...
  }, [formData, validatePassword, validateConfirmPassword, updatePassword, tokenValid, onSuccess, redirectTo]);
    ...
    <form onSubmit={handleSubmit} className="reset-password-form" noValidate>
      ...
      <div className="form-group">
        ...
        {errors.confirmPassword && (
          <span id={`${confirmPasswordId}-error`} className="form-error" role="alert">
            {errors.confirmPassword}
          </span>
        )}
      </div>
