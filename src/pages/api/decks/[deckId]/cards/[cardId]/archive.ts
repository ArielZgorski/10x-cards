/**
 * POST /api/decks/[deckId]/cards/[cardId]/archive - Archive a card (non-destructive)
 */

import type { APIRoute } from 'astro';
import { archiveCard } from '../../../../../../lib/flashcard.service';
...
export const POST: APIRoute = async ({ request, locals, params }) => {
  ...
  try {
    ...
    // Archive card
    const card = await archiveCard(supabase, deckId, cardId, user.id);
